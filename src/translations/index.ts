  ...
  lt: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Į sesijas neateinu su iš anksto sudarytu planu ar paruoštais atsakymais. Man svarbu sutikti jus ten, kur jūs esate. Kartu tyrinėjame tai, kas kyla – ar tai būtų skausmas, nerimas, pasimetimas, aiškumas ar tiesiog sunkiai įvardijama būsena. Žmonės dažnai kreipiasi dėl santykių sunkumų, emocinio nuovargio, nerimo, perdegimo ar jausmo, kad viduje kažkas sustojo. Mūsų darbe ieškome, kas iš tiesų vyksta jūsų vidiniame pasaulyje ir ko jums šiuo metu reikia.',
