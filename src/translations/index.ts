...
const translations: Record<Language, Translations> = {
  lt: {
    ...
    about: {
      title: 'Apie mane',
      paragraphs: [
        'Kaip terapeutas, stengiuosi atidžiai pastebėti, kas vyksta tarp mūsų čia ir dabar – pokalbyje, pauzėse, tame, kas jaučiasi lengva, ir tame, kas sunku. Tikiu, kad pokytis prasideda tada, kai galime susitikti atvirai, neskubėdami ir būdami su tuo, kas jums šiuo metu yra tikra.',
        'Mano kelią šiame darbe formavo klinikinė psichologija, studijos Prancūzijoje ir ilgalaikiai mokymai Lacano psichoanalizėje bei Gestalt terapijoje. Su metais vis aiškiau matau, kad pokytis vyksta tada, kai žmogus tampa sąmoningesnis to, kas jį jaudina – ne tik savo jausmų, bet ir šablonų, norų, konfliktų, gynybos mechanizmų, istorijų, kurių laikosi ar kurių vengia; dalykų, kurie kartojasi; net akimirkų, kai žodžiai praranda prasmę. Kai šie sluoksniai tampa matomesni, gyvenimas dažnai ima judėti iš sustingimo link didesnio atvirumo ir galimybių.',
        'Į terapiją neateinu su iš anksto sudėliotu planu ar paruoštais atsakymais – man svarbu sutikti jus tokius, kokie esate. Mano siekis yra būti su jumis su atvirumu, smalsumu ir jautrumu tam, ką patiriate – nesvarbu, ar tai skausmas, pasimetimas, aiškumas ar kažkas tarp šių patyrimų.',
        'Žmonės kreipiasi dėl įvairių sunkumų: santykių įtampos, emocinio skausmo, nerimo, perdegimo ar jausmo, kad viduje kažkas yra įstrigę. Kartu tyrinėjame, kas vyksta po paviršiumi ir ko prašo jūsų vidinis pasaulis.',
        'Terapiją matau kaip bendrą kūrybą. Kiekviena sesija yra unikali, nes ją formuoja mūsų abiejų įsitraukimas – jūsų atvirumas ir pasirengimas tyrinėti bei mano įsipareigojimas būti su jumis pagarbiai ir atidžiai.',
        'Tikiu, kad ši erdvė gali padėti lengviau kvėpuoti, aiškiau girdėti save ir iš naujo susisiekti su dalimis, kurios ilgą laiką tylėjo – kad galėtumėte judėti link gyvenimo, kuris jaučiasi laisvesnis, tvirtesnis ir labiau savas.'
      ],
      values: {
        professional: {
