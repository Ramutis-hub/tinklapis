...
export function ArticleLayout({ article, language }: ArticleLayoutProps) {
  const lang = language;

  return (
    <article className="bg-white">
      <div className="max-w-[44rem] mx-auto px-6 pt-8 md:pt-12 pb-10 md:pb-16">
        <Link
          to="/tekstai"
      ...
      <div className="max-w-[44rem] mx-auto px-6">
        <AuthorBio isEnglish={lang === 'en'} />
      </div>

      <RelatedArticles article={article} language={lang} />
    </article>
  );
}
